...
public class MaxSubArray {
	...
	public static void main(String[] args) {
		...
		/*
		 * EXPECTED OUTPUT: ---------------- Example 1: Input: [-2, 1, -3, 4, -1, 2, 1,
		 * -5, 4] Result: 6 Example 2: Input: [1, 2, 3, -4, 5, 6] Result: 13 Example 3:
		 * Input: [-1, -2, -3, -4, -5] Result: -1 Example 4: Input: [1, 2, 3, 4, 5]
		 * Result: 15 Example 5: Input: [1, -1, 1, -1, 1] Result: 1
		 */
